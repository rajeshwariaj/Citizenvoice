...
$query=mysqli_query($bd, "SELECT * FROM users WHERE userEmail='$email' and contactNo='$contact' AND aadhar_no='$aadhar_no'");
...
{
$errormsg="Invalid email id or Contact no or Aadhar";
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>CITIZEN VOICE | User Login</title>
